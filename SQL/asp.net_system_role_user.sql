...
CREATE TABLE `system_role_user` (
  ...
  KEY `system_role_id_idx` (`system_role_id`),
  CONSTRAINT `system_role_id` FOREIGN KEY (`system_role_id`) REFERENCES `system_role` (`id`),
...
INSERT INTO `system_role_user` VALUES (1,1,1),(3,2,2),(4,1,4),(5,2,3);
...
-- Dump completed on 2022-05-13 11:28:51
